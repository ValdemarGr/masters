...
\end{tikzpicture}
    ...
    \label{fig:expplot}
\end{figure}
\section{Type system abstractions}
The Hindley-Milner type system can only express simple programs which robs algorithmic elegance.
One domain of programs Hindley-Milner cannot express are those that rely on \textit{parametric polymorphism}.
