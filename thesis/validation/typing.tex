...
System F in undecidable, and as such, the Hindley-Milner type system will be of interest instead.
...
\begin{figure}[ht]
    ...
    \label{fig:polytree}
\end{figure}
The lack of $\sigma$ in \autoref{fig:polytree} since is controversial to introduce to the type hierarchy; $\sigma$ is but a mechanism to prove type systems.
