...
Under call by need all non results are saved for later use similar to techniques such as dynamic programming.
\begin{figure}
    \centering
        ...
        \begin{tikzpicture}[ scale=0.8, every node/.style={scale=0.8}, node distance = 0.3cm and 0.3cm]
                \node[circle, draw=black] (app1) {\texttt{app}};
                    ...
                    \path[-] (app1) edge node[left] {} (app2);
                        \node[circle, draw=red, below left = of app2] (value) {\texttt{value}};
                ...
                \node[circle, draw=black] (lamx) {\texttt{$\lambda$x}};
                    ...
                    \path[-] (lamx) edge node[left] {} (lamu);
                        ...
                        \path[-] (lamu) edge node[left] {} (app1);
                            \node[circle, draw=black, below right = of app1] (app2) {\texttt{app}};
                            \path[-] (app1) edge node[left] {} (app2);
                                \node[circle, draw=black, below right = of app2] (x1) {\texttt{x}};
                                \path[-] (app2) edge node[left] {} (x1);
                                \node[circle, draw=black, below = of app2] (force1) {\texttt{force}};
                            ...
                            \path[-] (app1) edge node[left] {} (app4);
                                ...
                                \node[circle, draw=black, below right = of app4] (app3) {\texttt{app}};
                                \path[-] (app4) edge node[left] {} (app3);
                                    \node[circle, draw=black, below = of app3] (x2) {\texttt{x}};
                                    \path[-] (app3) edge node[left] {} (x2);
                                    \node[circle, draw=black, below left = of app3] (force2) {\texttt{force}};
