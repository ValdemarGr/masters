...
One can implement a machine functions very closely to what the semantics describe.
...
\end{figure}
The algorithm in \autoref{fig:eval:laznaive} is correct and minimal but suffers from some practical issues.
In the true spirit of suspended computations, a suspended computation should have no impact on the performance characteristics.
