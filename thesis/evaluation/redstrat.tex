...
Two programs have been implemented to test the CPS machine with various garbage collection strategies and the effect of trimmers and environments.
\begin{figure}[ht]
    \centering
\begin{tikzpicture}
    \begin{axis}[
...
(10,31)  (20,230)  (25,1005) (30,9755)
   ...
   \end{axis} 
\end{tikzpicture}
    \caption{Fibonacci function time without trimming}
...
(10,39)  (20,130)  (25,11010) (30,770124)
   ...
   \end{axis} 
\end{tikzpicture}
    \caption{CPS machine performing under different strategies.}
